...
void printLoudest(void)
{
  ...
  if(ui32LoudestFrequency>100 && ui32LoudestFrequency<10000) // if sound is in approximate human voice range
	{
		digitalWrite(LED_BUILTIN, HIGH);   // turn the LED on (HIGH is the voltage level)
    Serial.printf("Loudest frequency: %d    VOICE DETECTED\n", ui32LoudestFrequency);
	}
	else
	{
...
void printPDMConfig(void)
{
  ...
  // Read the config structure to figure out what our internal clock is set to.
